      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-16 lg:py-20 bg-white">
          <div className="udaan-container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter text-udaan-navy md:text-4xl">Our Impact</h2>
                <p className="max-w-[900px] text-udaan-navy/70 md:text-xl/relaxed">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 py-8 md:grid-cols-4">
              <div className="flex flex-col items-center justify-center space-y-2 text-center bg-udaan-cream p-6 rounded-lg shadow-sm hover-lift">
                <h3 className="text-3xl font-bold text-udaan-orange sm:text-4xl md:text-5xl">150+</h3>
                <p className="text-sm font-medium text-udaan-navy sm:text-base">NGOs Registered</p>
              </div>
              <div className="flex flex-col items-center justify-center space-y-2 text-center bg-udaan-cream p-6 rounded-lg shadow-sm hover-lift">
                <h3 className="text-3xl font-bold text-udaan-orange sm:text-4xl md:text-5xl">1,200+</h3>
                <p className="text-sm font-medium text-udaan-navy sm:text-base">Skilled Individuals</p>
              </div>
              <div className="flex flex-col items-center justify-center space-y-2 text-center bg-udaan-cream p-6 rounded-lg shadow-sm hover-lift">
                <h3 className="text-3xl font-bold text-udaan-orange sm:text-4xl md:text-5xl">500+</h3>
                <p className="text-sm font-medium text-udaan-navy sm:text-base">Verified Skills</p>
              </div>
              <div className="flex flex-col items-center justify-center space-y-2 text-center bg-udaan-cream p-6 rounded-lg shadow-sm hover-lift">
                <h3 className="text-3xl font-bold text-udaan-orange sm:text-4xl md:text-5xl">75+</h3>
                <p className="text-sm font-medium text-udaan-navy sm:text-base">Partner Companies</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="flex flex-wrap gap-4 mt-6">
                {!user ? (
                  ...
                  <>
                    ...
                    <Link href="/ngos">
                      <Button size="lg" variant="udaan-navy-outline" className="h-12">Explore</Button>
                    </Link>
                  </>
                )}
              </div>
      ...
      <footer className="w-full border-t bg-udaan-cream py-6 md:py-12">
        <div className="udaan-container px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              <Link href="/" className="flex items-center gap-2 font-bold text-xl">
                ...
                <span className="text-udaan-navy">THE UDAAN COLLECTIVE</span>
              </Link>
          ...
          <div className="mt-8 border-t border-udaan-navy/10 pt-6 text-center text-sm text-udaan-navy/70">
            <p>&copy; {new Date().getFullYear()} The Udaan Collective. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>

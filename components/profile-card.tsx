          ...
          <div className="flex flex-wrap gap-1 pt-2">
            {displayTags.map((tag, index) => (
              <Badge 
                key={index} 
                variant="secondary" 
                className="bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 dark:from-blue-900/30 dark:to-indigo-900/30 dark:text-blue-300 backdrop-blur-sm border-opacity-30 transition-all duration-300 ease-in-out hover:scale-105"
